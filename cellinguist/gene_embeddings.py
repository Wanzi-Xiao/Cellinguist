...
def main():
    ...
    parser.add_argument("--out_embedding", type=str, required=True, help="Path to save output embedding as a csv.")
    ...
    full_model.eval()
    gene_emb_layer = full_model.token_embedding_layer.gene_embeddings
    gene_embeddings = gene_emb_layer.weight.detach().cpu()
